...
/datum/reagent/stim/mbr/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	M.stats.addTempStat(STAT_INT, STAT_LEVEL_ADEPT * effect_multiplier, STIM_TIME, "mbr")
	sanity_gain = 1

/datum/reagent/stim/mbr/withdrawal_act(mob/living/carbon/M)
	M.stats.addTempStat(STAT_INT, -STAT_LEVEL_BASIC, STIM_TIME, "mbr_w")
	M.stats.addTempStat(STAT_END, -STAT_LEVEL_BASIC, STIM_TIME, "mbr_w")
	sanity_gain = -1.5

/datum/reagent/stim/mbr/overdose(mob/living/carbon/M, alien)
	if(prob(5))
		M.vomit()
	if(ishuman(M) && prob(80 - (60 * (1 - M.stats.getMult(STAT_END)))))
...
/datum/reagent/stim/cherrydrops/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	M.stats.addTempStat(STAT_LCK, STAT_LEVEL_ADEPT * effect_multiplier, STIM_TIME, "cherrydrops")
	M.stats.addTempStat(STAT_INT, -STAT_LEVEL_ADEPT * effect_multiplier, STIM_TIME, "cherrydrops")
	sanity_gain = 1

/datum/reagent/stim/cherrydrops/withdrawal_act(mob/living/carbon/M)
	M.stats.addTempStat(STAT_INT, -STAT_LEVEL_BASIC, STIM_TIME, "cherrydrops_w")
	M.stats.addTempStat(STAT_LCK, -STAT_LEVEL_BASIC, STIM_TIME, "cherrydrops_w")
	M.stats.addTempStat(STAT_END, -STAT_LEVEL_BASIC, STIM_TIME, "cherrydrops_w")
	sanity_gain = -1.5
...
/datum/reagent/stim/pro_surgeon/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	M.stats.addTempStat(STAT_INT, STAT_LEVEL_ADEPT * effect_multiplier, STIM_TIME, "pro_surgeon")
	M.stats.addTempStat(STAT_LCK, -STAT_LEVEL_ADEPT * effect_multiplier, STIM_TIME, "pro_surgeon")
	sanity_gain = 1

/datum/reagent/stim/pro_surgeon/withdrawal_act(mob/living/carbon/M)
	M.stats.addTempStat(STAT_INT, -STAT_LEVEL_BASIC, STIM_TIME, "proSurgeon_w")
	M.stats.addTempStat(STAT_LCK, -STAT_LEVEL_BASIC, STIM_TIME, "proSurgeon_w")
	M.stats.addTempStat(STAT_AGI, -STAT_LEVEL_BASIC, STIM_TIME, "proSurgeon_w")
	sanity_gain = -1.5

/datum/reagent/stim/pro_surgeon/overdose(mob/living/carbon/M, alien)
	var/inverse_tough_mult = 1 - M.stats.getMult(STAT_END)
...
/datum/reagent/stim/violence/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	M.stats.addTempStat(STAT_STR, STAT_LEVEL_ADEPT * effect_multiplier, STIM_TIME, "violence")
	M.stats.addTempStat(STAT_AGI, -STAT_LEVEL_ADEPT * effect_multiplier, STIM_TIME, "violence")
	M.add_chemical_effect(CE_PULSE, 1)
	M.add_chemical_effect(CE_SPEECH_VOLUME, rand(3,4))
	sanity_gain = 1

/datum/reagent/stim/violence/withdrawal_act(mob/living/carbon/M)
	M.stats.addTempStat(STAT_STR, -STAT_LEVEL_BASIC, STIM_TIME, "violence_w")
	M.stats.addTempStat(STAT_AGI, -STAT_LEVEL_BASIC, STIM_TIME, "violence_w")
	sanity_gain = -1
...
/datum/reagent/stim/bouncer/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	M.stats.addTempStat(STAT_END, STAT_LEVEL_ADEPT * effect_multiplier, STIM_TIME, "bouncer")
	M.stats.addTempStat(STAT_STR, -STAT_LEVEL_ADEPT * effect_multiplier, STIM_TIME, "bouncer")
	sanity_gain = 1

/datum/reagent/stim/bouncer/withdrawal_act(mob/living/carbon/M)
	M.stats.addTempStat(STAT_END, -STAT_LEVEL_BASIC, STIM_TIME, "bouncer_w")
	M.stats.addTempStat(STAT_STR, -STAT_LEVEL_BASIC, STIM_TIME, "bouncer_w")
	sanity_gain = -1.5
...
/datum/reagent/stim/steady/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	M.stats.addTempStat(STAT_AGI, STAT_LEVEL_ADEPT * effect_multiplier, STIM_TIME, "steady")
	M.stats.addTempStat(STAT_END, -STAT_LEVEL_ADEPT * effect_multiplier, STIM_TIME, "steady")
	sanity_gain = 1

/datum/reagent/stim/steady/withdrawal_act(mob/living/carbon/M)
	M.stats.addTempStat(STAT_END, -STAT_LEVEL_BASIC, STIM_TIME, "steady_w")
	M.stats.addTempStat(STAT_AGI, -STAT_LEVEL_BASIC, STIM_TIME, "steady_w")
	if(prob(25 - (10 * (1 - M.stats.getMult(STAT_END)))))
		M.shake_animation(5)
	sanity_gain = -1.5
...
/datum/reagent/stim/machine_spirit/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	M.stats.addTempStat(STAT_INT, STAT_LEVEL_EXPERT * effect_multiplier, STIM_TIME, "machine_spirit")
	M.stats.addTempStat(STAT_LCK, -STAT_LEVEL_ADEPT * effect_multiplier, STIM_TIME, "machine_spirit")
	sanity_gain = 1.25

/datum/reagent/stim/machine_spirit/withdrawal_act(mob/living/carbon/M)
	M.stats.addTempStat(STAT_INT, -STAT_LEVEL_BASIC, STIM_TIME, "machineSpirit_w")
	M.stats.addTempStat(STAT_LCK, -STAT_LEVEL_BASIC, STIM_TIME, "machineSpirit_w")
	sanity_gain = -1.75
...
/datum/reagent/stim/grape_drops/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	M.stats.addTempStat(STAT_LCK, STAT_LEVEL_EXPERT * effect_multiplier, STIM_TIME, "grape_drops")
	M.stats.addTempStat(STAT_INT, -STAT_LEVEL_ADEPT * effect_multiplier, STIM_TIME, "grape_drops")
	sanity_gain = 1.25

/datum/reagent/stim/grape_drops/withdrawal_act(mob/living/carbon/M)
	M.stats.addTempStat(STAT_INT, -STAT_LEVEL_BASIC, STIM_TIME, "grapeDrops_w")
	M.stats.addTempStat(STAT_END, -STAT_LEVEL_BASIC, STIM_TIME, "grapeDrops_w")
	M.stats.addTempStat(STAT_LCK, -STAT_LEVEL_BASIC, STIM_TIME, "grapeDrops_w")
...
/datum/reagent/stim/ultra_surgeon/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	M.stats.addTempStat(STAT_INT, STAT_LEVEL_EXPERT * effect_multiplier, STIM_TIME, "ultra_surgeon")
	M.stats.addTempStat(STAT_LCK, -STAT_LEVEL_ADEPT * effect_multiplier, STIM_TIME, "ultra_surgeon")
	sanity_gain = 1.25

/datum/reagent/stim/ultra_surgeon/withdrawal_act(mob/living/carbon/M)
	M.stats.addTempStat(STAT_INT, -STAT_LEVEL_BASIC, STIM_TIME, "ultraSurgeon_w")
	M.stats.addTempStat(STAT_END, -STAT_LEVEL_BASIC, STIM_TIME, "ultraSurgeon_w")
	if(prob(25 - (10 * (1 - M.stats.getMult(STAT_END)))))
		M.shake_animation(8)
	sanity_gain = -1.75
...
/datum/reagent/stim/violence_ultra/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	M.stats.addTempStat(STAT_STR, STAT_LEVEL_EXPERT * effect_multiplier, STIM_TIME, "violence_ultra")
	M.stats.addTempStat(STAT_PER, STAT_LEVEL_EXPERT * effect_multiplier, STIM_TIME, "violence_ultra")
	M.stats.addTempStat(STAT_AGI, -STAT_LEVEL_ADEPT * effect_multiplier, STIM_TIME, "violence_ultra")
	M.stats.addTempStat(STAT_END, -STAT_LEVEL_ADEPT * effect_multiplier, STIM_TIME, "violence_ultra")
	sanity_gain = 1.25

/datum/reagent/stim/violence_ultra/withdrawal_act(mob/living/carbon/M)
	M.stats.addTempStat(STAT_STR, -STAT_LEVEL_BASIC, STIM_TIME, "violenceUltra_w")
	M.stats.addTempStat(STAT_PER, -STAT_LEVEL_BASIC, STIM_TIME, "violenceUltra_w")
	M.stats.addTempStat(STAT_END, -STAT_LEVEL_BASIC, STIM_TIME, "violenceUltra_w")
	M.stats.addTempStat(STAT_AGI, -STAT_LEVEL_BASIC, STIM_TIME, "violenceUltra_w")
	if(prob(25 - (10 * (1 - M.stats.getMult(STAT_END)))))
		M.shake_animation(8)
	M.adjustNutrition(-5)
	sanity_gain = -1.75
...
/datum/reagent/stim/boxer/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	M.stats.addTempStat(STAT_END, STAT_LEVEL_EXPERT * effect_multiplier, STIM_TIME, "boxer")
	M.stats.addTempStat(STAT_AGI, -STAT_LEVEL_ADEPT * effect_multiplier, STIM_TIME, "boxer")
	M.stats.addTempStat(STAT_STR, -STAT_LEVEL_ADEPT * effect_multiplier, STIM_TIME, "boxer")
	sanity_gain = 1.25

/datum/reagent/stim/boxer/withdrawal_act(mob/living/carbon/M)
	M.stats.addTempStat(STAT_INT, -STAT_LEVEL_BASIC, STIM_TIME, "boxer_w")
	M.stats.addTempStat(STAT_END, -STAT_LEVEL_BASIC, STIM_TIME, "boxer_w")
	sanity_gain = -1.75
...
/datum/reagent/stim/turbo/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	M.stats.addTempStat(STAT_AGI, STAT_LEVEL_EXPERT * effect_multiplier, STIM_TIME, "turbo")
	M.stats.addTempStat(STAT_END, -STAT_LEVEL_ADEPT * effect_multiplier, STIM_TIME, "turbo")
	M.stats.addTempStat(STAT_STR, -STAT_LEVEL_ADEPT * effect_multiplier, STIM_TIME, "turbo")
	sanity_gain = 1.25

/datum/reagent/stim/turbo/withdrawal_act(mob/living/carbon/M)
	M.stats.addTempStat(STAT_INT, -STAT_LEVEL_BASIC, STIM_TIME, "turbo_w")
	M.stats.addTempStat(STAT_END, -STAT_LEVEL_BASIC, STIM_TIME, "turbo_w")
	if(prob(25 - (5 * (1 - M.stats.getMult(STAT_END)))))
		M.shake_animation(8)
	sanity_gain = -1.75
...
/datum/reagent/stim/party_drops/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	M.stats.addTempStat(STAT_INT, STAT_LEVEL_EXPERT * effect_multiplier, STIM_TIME, "party_drops")
	M.stats.addTempStat(STAT_LCK, STAT_LEVEL_EXPERT * effect_multiplier, STIM_TIME, "party_drops")
	M.stats.addTempStat(STAT_AGI, -STAT_LEVEL_ADEPT * effect_multiplier, STIM_TIME, "party_drops")
	M.stats.addTempStat(STAT_CHR, -STAT_LEVEL_ADEPT * effect_multiplier, STIM_TIME, "party_drops")
	M.stats.addTempStat(STAT_END, -STAT_LEVEL_ADEPT * effect_multiplier, STIM_TIME, "party_drops")
	M.stats.addTempStat(STAT_STR, -STAT_LEVEL_ADEPT * effect_multiplier, STIM_TIME, "party_drops")
	sanity_gain = 1

/datum/reagent/stim/party_drops/withdrawal_act(mob/living/carbon/M)
	M.stats.addTempStat(STAT_INT, -STAT_LEVEL_BASIC, STIM_TIME, "partyDrops_w")
	M.stats.addTempStat(STAT_LCK, -STAT_LEVEL_BASIC, STIM_TIME, "partyDrops_w")
	if(prob(25 - (5 * (1 - M.stats.getMult(STAT_END)))))
		M.shake_animation(8)
	sanity_gain = -2

/datum/reagent/stim/party_drops/overdose(mob/living/carbon/M, alien)
	var/wound_chance = 80 - (79 * (1 - M.stats.getMult(STAT_END)))
	M.adjustBrainLoss(2)
	M.slurring = max(M.slurring, 30)
	if(prob(5))
		M.vomit()
...
/datum/reagent/stim/menace/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	M.stats.addTempStat(STAT_AGI, STAT_LEVEL_EXPERT * effect_multiplier, STIM_TIME, "menace")
	M.stats.addTempStat(STAT_CHR, STAT_LEVEL_EXPERT * effect_multiplier, STIM_TIME, "menace")
	M.stats.addTempStat(STAT_END, STAT_LEVEL_EXPERT * effect_multiplier, STIM_TIME, "menace")
	M.stats.addTempStat(STAT_STR, STAT_LEVEL_EXPERT * effect_multiplier, STIM_TIME, "menace")
	M.stats.addTempStat(STAT_INT, -STAT_LEVEL_ADEPT * effect_multiplier, STIM_TIME, "menace")
	M.stats.addTempStat(STAT_LCK, -STAT_LEVEL_ADEPT * effect_multiplier, STIM_TIME, "menace")
	M.slurring = max(M.slurring, 30)
	M.add_chemical_effect(CE_SPEECH_VOLUME, 4)
	sanity_gain = 1

/datum/reagent/stim/menace/withdrawal_act(mob/living/carbon/M)
	M.stats.addTempStat(STAT_AGI, -STAT_LEVEL_ADEPT, STIM_TIME, "menace_w")
	M.stats.addTempStat(STAT_CHR, -STAT_LEVEL_ADEPT, STIM_TIME, "menace_w")
	M.stats.addTempStat(STAT_END, -STAT_LEVEL_ADEPT, STIM_TIME, "menace_w")
	M.stats.addTempStat(STAT_STR, -STAT_LEVEL_ADEPT, STIM_TIME, "menace_w")
	if(prob(25 - (5 * (1 - M.stats.getMult(STAT_END)))))
		M.shake_animation(8)
	M.adjustNutrition(-7)
	sanity_gain = -2
