...
/datum/perk/big_shot/assign(mob/living/carbon/human/H)
	if(..())
		initial_time = world.time
		holder.stats.addTempStat(STAT_STR, 20, INFINITY, "Big Shot")
		holder.stats.addTempStat(STAT_PER, 35, INFINITY, "Big Shot")
		holder.stats.addTempStat(STAT_END, 20, INFINITY, "Big Shot")
		holder.stats.addTempStat(STAT_CHR, 35, INFINITY, "Big Shot")
		holder.stats.addTempStat(STAT_INT, 20, INFINITY, "Big Shot")
		holder.stats.addTempStat(STAT_AGI, 35, INFINITY, "Big Shot")
		holder.stats.addTempStat(STAT_LCK, 35, INFINITY, "Big Shot")


/datum/perk/big_shot/remove()
	if(holder)
		holder.stats.removeTempStat(STAT_STR, "Big Shot")
		holder.stats.removeTempStat(STAT_PER, "Big Shot")
		holder.stats.removeTempStat(STAT_END, "Big Shot")
		holder.stats.removeTempStat(STAT_CHR, "Big Shot")
		holder.stats.removeTempStat(STAT_INT, "Big Shot")
		holder.stats.removeTempStat(STAT_AGI, "Big Shot")
		holder.stats.removeTempStat(STAT_LCK, "Big Shot")
	..()
